...
#include <string>
#include <vector>
#include "../Task2_cpp/SystemOfLinearEquation.h"
#include "../Task2_cpp/SystemOfLinearEquation.cpp"
#include "../Task2_cpp/LinearEquation.h"
#include "../Task2_cpp/LinearEquation.cpp"

using namespace Microsoft::VisualStudio::CppUnitTestFramework;

namespace UnitTestSystemOfLinearEquation_cpp
{
	TEST_CLASS(UnitTestSystemOfLinearEquation_cpp)
	{
	public:
